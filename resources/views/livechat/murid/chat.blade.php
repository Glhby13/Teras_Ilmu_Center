...
<div class="container mt-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            if (typeof jQuery !== 'undefined') {
                function refreshUstazOnline() {
                    jQuery.get("{{ route('murid.ustazOnline') }}", function(data) {
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function fetchMessages() {
                    ...
                    fetch(`/api/murid/livechat/${livechatId}/messages`)
    ...
    <!-- resources/views/livechat/murid/chat.blade.php -->
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script>
        $(document).ready(function() {
            $('#message-form').on('submit', function(e) {
                ...
                var url = "{{ route('muridlivechat.send') }}";
                ...
                $.post(url, formData, function(data) {
                    ...
                    <div class="d-flex justify-content-end mb-4">
                        <div class="me-3 text-end">
                            <div class="bg-primary text-white p-2 rounded">
                                <strong>{{ Auth::user()->murid->nama }}</strong>
